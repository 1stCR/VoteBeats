...
This command **requires** the project directory as an argument via `C:\VoteBeats`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\VoteBeats/prompts/app_spec.txt` and `C:\VoteBeats/prompts/initializer_prompt.md`

If `C:\VoteBeats` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\VoteBeats/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\VoteBeats/prompts/app_spec.txt`
...
**Output path:** `C:\VoteBeats/prompts/initializer_prompt.md`
...
**Output path:** `C:\VoteBeats/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\VoteBeats/prompts/`!
>
> **Files created:**
> - `C:\VoteBeats/prompts/app_spec.txt`
> - `C:\VoteBeats/prompts/initializer_prompt.md`
>
